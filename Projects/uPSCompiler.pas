...
interface
uses
  {$IFNDEF DELPHI3UP}{$IFNDEF PS_NOINTERFACES}{$IFNDEF LINUX}Winapi.Windows, Winapi.Ole2,{$ENDIF}
  {$ENDIF}{$ENDIF}System.SysUtils, uPSUtils;
...
uses {$IFDEF DELPHI5}ComObj, {$ENDIF}{$IFDEF PS_FPC_HAS_COM}ComObj, {$ENDIF}System.Classes, System.typInfo;
